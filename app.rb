...
def initialize_kafka
  ...
  tmp_ca_file.write(ENV.fetch('HEROKU_KAFKA_V2_8_TRUSTED_CERT'))
  tmp_ca_file.close
  ...
  producer_kafka = Kafka.new(
    seed_brokers: ENV.fetch('HEROKU_KAFKA_V2_8_URL'),
    ssl_ca_cert_file_path: tmp_ca_file.path,
    ssl_client_cert: ENV.fetch('HEROKU_KAFKA_V2_8_CLIENT_CERT'),
    ssl_client_cert_key: ENV.fetch('HEROKU_KAFKA_V2_8_CLIENT_CERT_KEY'),
